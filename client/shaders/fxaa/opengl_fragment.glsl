// Most code borrowed from http://blog.simonrodriguez.fr/articles/2016/07/implementing_fxaa.html
// In order to do this, we need to use version 130, not 120. This bumps the version on ALL shaders, so beware of any possible errors made by this.

#define screenTexture texture0
...
#define EDGE_THRESHOLD_MAX 0.120 // originally 0.125
#define SUBPIXEL_QUALITY 1.1
...
vec2 screenSize = vec2(1920, 1054);
vec2 inverseScreenSize = vec2(1/screenSize.x, 1/screenSize.y);
